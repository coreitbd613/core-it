const steps = [
  {
    number: "01",
    title: "Discovery",
    description: "We map out the app's core flows and the platforms you need to reach.",
  },
  {
    number: "02",
    title: "Design & build",
    description: "We design the screens, build the app, and check in as it comes together.",
  },
  {
    number: "03",
    title: "Launch & support",
    description: "We publish the app to the store and stay on for updates after launch.",
  },
]
